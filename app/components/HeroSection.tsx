...
export default function HeroSection() {
  return (
    <div className="max-w-[1600px] md:max-w-ful  flex flex-col-reverse  md:flex-row  bg-primaryColor mt-10  m-auto">
      <div className="flex flex-1  flex-col justify-center   p-4  ">
        <h1 className=" font-bold w-full sm:w-[200px] text-left text-6xl">
        ...
        <button className=" mt-8  text-center bg-secondaryColor rounded-full text-whiteColor p-2 w-[150px] sm:w-full">
          Shop Now
        </button>
